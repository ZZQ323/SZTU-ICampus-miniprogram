...
import type { AnnouncementContent } from '@/types/announcement'
...
const content = ref<AnnouncementContent | null>(null)
const error = ref('')
...
const mockContent: AnnouncementContent = {
    id: '50731',
...
async function fetchDetail() {
    ...
    try {
        const result = await announcementApi.getDetail(id.value)
